...
public class TransactionTest {
	...
	public static void main(String[] args) {
		...
		String sql1 = "UPDATE `bank_transaction` SET `t_amount` = `t_amount` - 10000 WHERE `t_a_no`=?";
		String sql2 = "UPDATE `bank_transaction` SET `t_amount` = `t_amount` + 10000 WHERE `t_a_no`=?";
