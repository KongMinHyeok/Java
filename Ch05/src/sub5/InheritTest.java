 ...
 * 
 * 상속(Inheritance)
 *  - 기존 클래스의 속성과 기능을 그대로 자식 클래스에게 돌려주는 클래스 확장 문법
 *  - 공통적인 로직 내용을 부모클래스(슈퍼클래스)에 두고 자식 클래스(서브클래스) 에서 상속 받아 일관성있는 프로그래밍 수행
 *  - 부모 크래스의 속성 접근권한은 protected 선언해서 자식 클래스에서만 참조 되도록 수정
 */
class Parent{
